 ...
 * a bottom sheet.
 */
public class BottomSheetBehavior_v25<V extends View> extends CoordinatorLayout.Behavior<V> implements ICustomBottomSheetBehavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(@NonNull View bottomSheet, @BottomSheetBehavior_v25.State int newState);
    ...
    private BottomSheetBehavior_v25.BottomSheetCallback mCallback;
     ...
     */
    public BottomSheetBehavior_v25() {
    }
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new BottomSheetBehavior_v25.SavedState(super.onSaveInstanceState(parent, child), mState);
    }

    @Override
    public void onRestoreInstanceState(CoordinatorLayout parent, V child, Parcelable state) {
        BottomSheetBehavior_v25.SavedState ss = (BottomSheetBehavior_v25.SavedState) state;
...
//        }
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ...
            ViewCompat.postOnAnimation(child, new BottomSheetBehavior_v25.SettleRunnable(child, targetState));
        } else {
     ...
     */
    public void setBottomSheetCallback(BottomSheetBehavior_v25.BottomSheetCallback callback) {
        mCallback = callback;
    }
     ...
     *              {@link #STATE_HIDDEN}.
     */
    public final void setState(final @BottomSheetBehavior_v25.State int state) {
        if (state == mState) {
            return;
        }
        if (mViewRef == null) {
    ...
    void setStateInternal(@BottomSheetBehavior_v25.State int state) {
        if (mState == state) {
            return;
        }
        mState = state;
    ...
    void startSettlingAnimation(View child, int state) {
        ...
        setStateInternal(STATE_SETTLING);
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ViewCompat.postOnAnimation(child, new BottomSheetBehavior_v25.SettleRunnable(child, state));
        }
    }
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            int top;
            @BottomSheetBehavior_v25.State int targetState;
            if (yvel < 0) { // Moving up
                top = mMinOffset;
                targetState = STATE_EXPANDED;
            ...
            if (mViewDragHelper.settleCapturedViewAt(releasedChild.getLeft(), top)) {
                ...
                ViewCompat.postOnAnimation(releasedChild,
                        new BottomSheetBehavior_v25.SettleRunnable(releasedChild, targetState));
            } else {
                setStateInternal(targetState);
            }
        }
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable(View view, @BottomSheetBehavior_v25.State int targetState) {
            mView = view;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @BottomSheetBehavior_v25.State int state) {
            super(superState);
            this.state = state;
        }
        ...
        public static final Creator<BottomSheetBehavior_v25.SavedState> CREATOR = ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks<BottomSheetBehavior_v25.SavedState>() {
                    @Override
                    public BottomSheetBehavior_v25.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                        return new BottomSheetBehavior_v25.SavedState(in, loader);
                    }

                    @Override
                    public BottomSheetBehavior_v25.SavedState[] newArray(int size) {
                        return new BottomSheetBehavior_v25.SavedState[size];
                    }
                });
    }

    /**
     * A utility function to get the {@link BottomSheetBehavior_v25} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehavior_v25}.
     * @return The {@link BottomSheetBehavior_v25} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehavior_v25<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomSheetBehavior_v25)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (BottomSheetBehavior_v25<V>) behavior;
    }
